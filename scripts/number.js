/**
 * @fileOverview Contains utility functions to prettify numbers.
 */

/** Returns a prettified version of the given number.
* @param {float} x - The number to be prettified.
...
/** Returns a shortened prettified version of the given number.
* @param {float} x - The number to be prettified.
* @return {string} - The prettified string.
*/
...
* @param {float} x - The number to be be rounded.
* @return {float} - The rounded number.
*/
function roundPlace(x) {
	return (Math.round(x*100)/100);
}
/** Forces the given number to display up to the hundredth place.
* @param {float} x - The number to be be fixed.
...
/** Converts given number of seconds to H-M-S format.
* @param {float} x - Total number of seconds.
